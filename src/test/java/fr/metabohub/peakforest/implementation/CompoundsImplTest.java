...
//	}
	...
	public void testGetCompounds() {
		...
		Assert.assertEquals(1,
				CompoundsImpl.getCompounds("caffeine - junit", null, null, null, null, null, null).size(), 0);
		Assert.assertEquals(1, CompoundsImpl.getCompounds("RYYVLZVUVIJVGH", null, null, null, null, null, null).size(),
				0);
		Assert.assertEquals(1, CompoundsImpl.getCompounds("C8H10N4O2", null, null, null, null, null, null).size(), 0);
		// tests OK spec
		Assert.assertEquals(1,
				CompoundsImpl.getCompounds("caffeine - junit", "name", null, null, null, null, null).size(), 0);
		Assert.assertEquals(1, CompoundsImpl.getCompounds("C8H10N4O2", "formula", null, null, null, null, null).size(),
				0);
		Assert.assertEquals(1,
				CompoundsImpl.getCompounds("RYYVLZVUVIJVGH", "inchikey", null, null, null, null, null).size(), 0);
		// tests KO spec
		Assert.assertEquals(0,
				CompoundsImpl.getCompounds("caffeine - junit", "formula", null, null, null, null, null).size(), 0);
		Assert.assertEquals(0,
				CompoundsImpl.getCompounds("RYYVLZVUVIJVGH", "name", null, null, null, null, null).size(), 0);
		Assert.assertEquals(0, CompoundsImpl.getCompounds("C8H10N4O2", "inchikey", null, null, null, null, null).size(),
				0);
	}
	...
	public void testGetCompoundsProperties() {
		...
		Assert.assertEquals(1,
				((List<?>) CompoundsImpl.getCompoundsProperties(null, "C8H10N4O2", null, null, null, null, null, null))
						.size(),
				0);
		// tests OK spec
		...
		Assert.assertEquals(1, ((List<?>) CompoundsImpl.getCompoundsProperties((new ArrayList<String>()),
				"RYYVLZVUVIJVGH", "inchikey", null, null, null, null, null)).size(), 0);
		// test OK - count
		Assert.assertEquals(1,
				((Integer) CompoundsImpl.getCompoundsProperties(count, null, null, null, null, null, null, null)), 0);
